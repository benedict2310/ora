...
| [Parakeet Starter](parakeet-starter/) | S.01 - S.05 | ASR engine integration (FluidAudio Parakeet) | 🟡 2 in review · 📝 1 ready for implementation · 📝 2 draft |
...
| Order | Story | Title | Effort | Critical Path | Status |
|:-----:|:------|:------|:------:|:-------------:|:-------|
| 10 | S.01 | [Core Engine Integration](parakeet-starter/S.01-CORE-ENGINE-INTEGRATION.md) | 2d | ✅ | 🟡 In Review |
