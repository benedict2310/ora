    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                .disabled(self.viewModel.openAIKeyStatus != .saved && !self.viewModel.codexAuthStatus.isConnected)
                ...
                HStack(spacing: 8) {
                    ...
                    .disabled(self.viewModel.codexAuthStatus == .connecting || self.viewModel.codexAuthStatus.isConnected)
